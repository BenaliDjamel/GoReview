...
<template>
    ...
    <div class="gradient">
        <!--Nav-->
        <section class="py-6 gradient">
            <header
                class="container px-3 mx-auto flex-none hidden sm:flex justify-between"
            >
                <div class="flex items-center">
                    <Link href="/" class="font-bold text-white text-2xl">
                        GoReview
                    </Link>
                </div>
            ...
            >
                ...
                <div class="w-full md:w-3/6 py-6 text-center">
                    <img
                        ...
                        src="../../images/code-review-amico.png"
                    />
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        <h3 class="text-3xl text-gray-800 font-bold mb-3">
                            You can Submit Your Request And Get reviewed.
                        </h3>
                        <p class="text-gray-600 mb-2">
                            Submit your requests and get reviewed by many
                            talented developers on our platform, who shares
                            insightful reviews.
                        </p>
                        <Link 
                      href="/create"
                            class="mx-auto lg:mx-0 hover:underline bg-blue-600 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                        >
                            Submit
                        </Link>
                    </div>
        ...
        <section class="container mx-auto text-center py-6 mb-12">
            ...
            <h3 class="my-4 text-2xl text-white leading-tight">
                Review other developers code, and get your code reviewed by
                others
            </h3>
            <Link
            href="/register"
        ...
        <footer class="bg-white">
            <div class="container mx-auto px-8">
                <div class="w-full flex flex-col md:flex-row py-6">
                    ...
                    <div class="flex-1">
                        <p class="uppercase text-gray-500 md:mb-6">Owned By</p>
                        <ul class="list-reset mb-6">
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a
                                    href="#"
...
<style>
.gradient {
    background: linear-gradient(90deg, #3a86ff 0%, #776de2 100%);
}
</style>
